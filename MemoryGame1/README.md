# Project 4 - *MemoryGame1*

Submitted by: **Cristian De Francesco**

**MemoryGame1** is an app that is a memory game. it has a card shaped system that has a flip like action that holds an image. if the image of two cards match the cards are eliminated. there is a reset button to start the game over by shuffling the cards. 
...
https://www.loom.com/share/b35e9e1764e245ce89a7e1c44861056f?sid=3f56a214-f770-4ed9-b542-0a2ea963947a.

## Notes

the app was pretty straight forward. biggest difficulty was setting the reset button. 

## License

    Copyright [2024] [Cristian De Francesco]
